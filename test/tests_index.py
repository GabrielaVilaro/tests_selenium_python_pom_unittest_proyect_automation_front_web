...
class SearchCases(unittest.TestCase):
    ...
    def test_search_no_element(self):
        '''Este test busca un elemento inválido y verifica que la página devuelva un mensaje de error error'''
    ...
    def test_search_element_valid(self):
        '''Esre test busca un elemento válido y verifica que aparezca correctamente el nombre del elemento'''
    ...
    def test_button_orange(self):
        '''Este test busca un elemento, elige el color naranja, agrega 8 y verifica que el número coincida'''
    ...
    def test_list_product_selection(self):
        '''Este test toma diferentes valores de la lista de métodos de filtrado de una búsqueda'''
    ...
    def test_check_phone_number(self):
        '''Este test checkea el número de teléfono de la página'''
